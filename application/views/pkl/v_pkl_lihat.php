...
<div class="container m-5  ">
	...
	<form class="mb-4" action="<?php echo base_url('c_pkl/simpandata');?>" method="post">
		...
		<div class="mb-3">
			...
			<select id="mhs" name="mhs" class="form-select" disabled>
				<option value=""><?php echo $tampil->npm ?> - <?php echo $tampil->nama ?></option>
		...
		<div class="mb-3">
			...
			<select id="tempat" name="tempat" class="form-select" disabled>
				<option value=""><?php echo $tampil->nama_tempat ?>t</option>
		...
		<div class="mb-3">
			...
			<select id="dosen" name="dosen" class="form-select" disabled>
				<option value=""><?php echo $tampil->nama_dosen ?></option>
		...
		<a href="<?php echo base_url('c_pkl') ?>" class="btn btn-primary">Kembali</a>
	</form>
</div>
<!-- akhir isi -->
