...
<div class="container m-5  ">
	...
	<form class="mb-4" action="<?php echo base_url('c_mahasiswa/simpanedit');?>" method="post">
		


	<div class="mb-3">
			<label for="nama" class="form-label">NPM</label>
			<input type="text" value="<?php echo $tampil->npm ?>" name="npm" class="form-control" id="npm" >
			<div id="npm" class="form-text text-danger"><?php echo form_error('npm'); ?></div>
		</div>
		<div class="mb-3">
			<label for="nama" class="form-label">Nama </label>
			<input type="text" value="<?php echo $tampil->nama ?>" name="nama" class="form-control" id="nama" >
			<input type="hidden" name="id" value="<?php echo $tampil->npm ?>">
		...
		<div class="mb-3">
			...
			<select id="prodi" name="prodi" class="form-select" >
				<option value="<?php echo $tampil->id_programstudi ?>"><?php echo $tampil->program_studi ?></option>
		...
		<div class="mb-3">
			...
			<input type="text" value="<?php echo $tampil->alamat ?>" name="alamat" class="form-control" id="alamat">
		...
		<div class="mb-3">
			...
			<input type="text" value="<?php echo $tampil->no_hp ?>" name="nohp" class="form-control" id="nohp">
			...
			<input type="text" value="<?php echo $tampil->ttl ?>" name="ttl" class="form-control" id="ttl" >
